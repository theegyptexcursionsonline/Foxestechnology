...
const PAGE_PATH = '/operators/dinner-cruises';

const copy = getOperatorCopy('dinner-cruises', 'en');
...
export default function Page() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Service',
        name: 'Foxes Technology for Dinner Cruise Operators',
        provider: {
          '@type': 'Organization',
        ...
        serviceType: 'Booking software for dinner cruise operators',
        description: copy.meta.description,
        audience: {
          '@type': 'BusinessAudience',
          audienceType: 'Dinner cruise operators',
        },
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <>
      ...
      />
      <DinnerCruisesPage copy={copy} locale="en" whatsappNumber={whatsappNumber} />
    </>
  );
}
