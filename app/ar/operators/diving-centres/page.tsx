...
import DivingCentresPage from '@/components/operators/DivingCentresPage';
...
const PAGE_PATH = '/ar/operators/diving-centres';
const ALT_EN_PATH = '/operators/diving-centres';

const copy = getOperatorCopy('diving-centres', 'ar');
...
export default function Page() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Service',
        name: 'Foxes Technology لمراكز الغوص',
        provider: {
          '@type': 'Organization',
        ...
        serviceType: 'برنامج حجوزات لمراكز الغوص',
        description: copy.meta.description,
        audience: {
          '@type': 'BusinessAudience',
          audienceType: 'مشغلو مراكز الغوص',
        },
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <RTLProvider>
      ...
      />
      <DivingCentresPage copy={copy} locale="ar" whatsappNumber={whatsappNumber} />
    </RTLProvider>
  );
}
