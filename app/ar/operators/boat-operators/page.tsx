...
import { ar as copy } from '@/lib/i18n/copy/boat-operators';

const SITE_URL = 'https://foxestechnology.com';
const PAGE_PATH = '/ar/operators/boat-operators';
const ALT_EN_PATH = '/operators/boat-operators';
...
export default function Page() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Service',
        name: 'Foxes Technology لمشغلي القوارب والشحن',
        provider: {
          '@type': 'Organization',
        ...
        serviceType: 'برنامج حجوزات لمشغلي القوارب والشحن',
        description: copy.meta.description,
        audience: {
          '@type': 'BusinessAudience',
          audienceType: 'مشغلو القوارب والشحن',
        },
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <RTLProvider>
      ...
      />
      <BoatOperatorsPage copy={copy} locale="ar" whatsappNumber={whatsappNumber} />
    </RTLProvider>
  );
}
