...
import { ar as copy } from '@/lib/i18n/copy/water-sports';

const SITE_URL = 'https://foxestechnology.com';
const PAGE_PATH = '/ar/operators/water-sports';
const ALT_EN_PATH = '/operators/water-sports';
...
export default function Page() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Service',
        name: 'Foxes Technology لمشغلي الرياضات المائية',
        provider: {
          '@type': 'Organization',
        ...
        serviceType: 'برنامج حجوزات لمشغلي الرياضات المائية',
        description: copy.meta.description,
        audience: {
          '@type': 'BusinessAudience',
          audienceType: 'مشغلو الرياضات المائية',
        },
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <RTLProvider>
      ...
      />
      <WaterSportsPage copy={copy} locale="ar" whatsappNumber={whatsappNumber} />
    </RTLProvider>
  );
}
