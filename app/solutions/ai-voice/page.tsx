...
const PAGE_PATH = '/solutions/ai-voice';

const copy = getOperatorCopy('ai-voice', 'en');
...
export default function Page() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        serviceType: 'AI voice agent for tour operators',
        description: copy.meta.description,
        audience: {
          '@type': 'BusinessAudience',
          audienceType: 'Tour operators, dive centres, dinner cruises, water sports, charter boats',
        },
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <>
      ...
      />
      <AIVoicePage copy={copy} locale="en" whatsappNumber={whatsappNumber} />
    </>
  );
}
