  ...
  return (
    <CurrencyProvider>
      ...
      <main data-operator-page="boat-operators" className="overflow-hidden bg-white text-slate-900">
        ...
        <OperatorEcosystem category="boat-operators" locale={locale} />
        <FinalCTA copy={copy} whatsappHref={whatsappHref} locale={locale} />
      </main>

      <OperatorFooter category="boat-operators" locale={locale} whatsappHref={whatsappHref} />
      ...
      <MobileStickyCTA
        ...
        locale={locale}
      />
      <OperatorExitIntent copy={copy.exitIntent} category="boat-operators" locale={locale} />
    </CurrencyProvider>
  );
}
